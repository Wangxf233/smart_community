<template>
  <el-card>
    <el-table border style="margin: 10px 0;" :data="skuArr">
      <el-table-column label="序号" type="index" align="center" width="110px"></el-table-column>
      ...
      <el-table-column label="重量" width="200px" align="center" prop="weight"></el-table-column>
      <el-table-column label="价格" width="200px" align="center" prop="price"></el-table-column>
      <el-table-column label="操作" width="247px" fixed="right" align="center">
        <template #="{ row }">
...
const removeSku = async (id: number) => {
  ...
  if (result.code == 200) {
    ...
    //删除失败
    ElMessage({ type: 'error', message: '系统数据不允许删除' });
  }
}
